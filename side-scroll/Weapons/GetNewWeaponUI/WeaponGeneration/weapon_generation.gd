...
@export var weapon_type_chances_calculation: WeaponTypeChancesCalculation



func generate_weapons():
	for new_weapon in all_generation_count:
		var new_weapon_data:WeaponData = weapon_type_chances_calculation.get_random_weapon_type()
